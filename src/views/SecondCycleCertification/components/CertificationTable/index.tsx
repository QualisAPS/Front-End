  ...
  const columns = useMemo<ColumnDef<UsersTypeWithAction, any>[]>(
    () => [
      ...
      */
      ...
      columnHelper.accessor('cert_2_ciclo', {
        header: 'Classificação',
        cell: ({ row }) => <Typography>{row.original.cert_2_ciclo}</Typography>
      }),
      columnHelper.accessor('cert_nota_2_ciclo', {
        header: 'Nota',
        cell: ({ row }) => <Typography>{row.original.cert_nota_2_ciclo}</Typography>
      })
    ],

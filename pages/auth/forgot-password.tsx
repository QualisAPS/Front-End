...
import { setPageTitle } from '@/src/store/themeConfigSlice';
import { toggleLocale } from '@/src/store/themeConfigSlice';
import { toggleRTL } from '@/src/store/themeConfigSlice';
...
const RegisterBoxed = () => {
  ...
  useEffect(() => {
    dispatch(setPageTitle('Criar Conta'));
  });
        ...
        <div className="relative w-full max-w-[870px] rounded-md bg-[linear-gradient(45deg,#fff9f9_0%,rgba(255,255,255,0)_25%,rgba(255,255,255,0)_75%,_#fff9f9_100%)] p-2 dark:bg-[linear-gradient(52.22deg,#0E1726_0%,rgba(14,23,38,0)_18.66%,rgba(14,23,38,0)_51.04%,rgba(14,23,38,0)_80.07%,#0E1726_100%)]">
          <div className="relative flex flex-col justify-center rounded-md bg-white/60 px-6 py-20 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px]">
            ...
            <div className="mx-auto w-full max-w-[440px]">
              <div className="mb-10">
                <h1 className="text-3xl font-extrabold uppercase !leading-snug text-green md:text-4xl">
                QualisAPS
                </h1>
                <p className="text-base font-bold leading-normal text-dark">
                  Preencha o formulario para fazer uma conta
                </p>
              </div>
              ...
              <div className="text-center dark:text-white">
                ...
                <Link
                  href="/auth/login"
                  className="uppercase text-green underline transition hover:text-black dark:hover:text-white"
                >
                  Faça o login
                </Link>
              </div>

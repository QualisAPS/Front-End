...
const AccountSetting = () => {
  ...
  useEffect(() => {
    dispatch(setPageTitle('Configurações da Conta'));
  });
        ...
        {tabs === 'home' ? (
          <div>
            <form className="mb-5 rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-black">
              <h6 className="mb-5 text-lg font-bold">Informações Gerais</h6>
                ...
                <div className="grid flex-1 grid-cols-1 gap-5 sm:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      id="email"
                      type="email"
                      placeholder="equipex@gmail.com"
                      className="form-input"
                    />
                  </div>
                  <div>
                    <label htmlFor="web">Alguma informacao</label>
                    <input
                      id="web"
                      type="text"
            ...
            <form className="rounded-md border border-[#ebedf2] bg-white p-4 dark:border-[#191e3a] dark:bg-black">
              <h6 className="mb-5 text-lg font-bold">Redes Sociais</h6>
